...
export const OrderForm: FormSection[] = [
    {
        ...
        fields: [
            ...
            { type: "datetime-local", name: "orderDate", label: "Order Date", required: true },
            { type: "text", name: "description", label: "Product Description", required: false },
            ...
            {
                type: "page-api-select",
                name: "customerExternalId", // to display this value as pre-selected in update form
                ...
                // 🔥 apiById mapping
                apiByIdIdKey: "id",
                apiByIdValueKey: "externalId",
                apiByIdLabelKey: "name",
            }
        ]
    },
    {
        ...
        fields: [
            {
                ...
                // lookup mapping
                idKey: "productId", // for apiById
                valueKey: "productExternalId",         // backend response field mapping for get the externalId
                labelKey: "productName",       // show the value drop down list
